...
{
    #[Route('/',
        name: 'app_homepage'  //sirve para el enrutamiento en la app y los links en twig
    )]
    ...
    #[Route('/browse/{slug}',
        name: 'app_browse'
    )]     //{slug} it's a Wildcard can be another word it#s make no difference// can match anything but by default a wild card is required, must be an adress after /browse
